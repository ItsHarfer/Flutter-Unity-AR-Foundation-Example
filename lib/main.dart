...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'Flutter <> Unity AR Foundation App',
      theme: ThemeData(
        primarySwatch: Colors.blue,
        visualDensity: VisualDensity.adaptivePlatformDensity,
      ),
      home: MyHomePage(title: 'Flutter <> Unity AR Foundation App'),
    );
  }
}
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Flutter with Unity AR Foundation'),
      ),
      body: Center(
        child: RaisedButton(
          onPressed: () {
...
class _UnityViewPageState extends State<UnityViewPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('AR Image Detection'),
      ),
      body: Stack(
        children: <Widget>[
          UnityView(
          ...
          Positioned(
            ...
            child: Card(
              ...
              child: Column(
                children: <Widget>[
                  // Overlay Content here if you want
                ],
              ),
            ),
          ),
